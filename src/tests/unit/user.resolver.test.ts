...
describe('userResolvers', () => {
  ...
  describe('Query.me', () => {
    ...
    it('should throw error when not authenticated', async () => {
      await expect(
        userResolvers.Query.me(null, null, { user: null })
  ...
  describe('Mutation.register', () => {
    ...
    it('should throw error for duplicate email', async () => {
      ...
      (User.findOne as jest.Mock).mockResolvedValue({ email: mockInput.email });

      await expect(
        userResolvers.Mutation.register(null, { input: mockInput })
